...
//     Future.microtask(
//       () => ref.read(barbersControllerProvider.notifier).fetchBarbers(),
//     );
//   }
...
//         onRefresh: () async {
//           await ref.read(barbersControllerProvider.notifier).fetchBarbers();
//         },
//         child: Column(
//           children: [
...
//               data: (_) {
//                 print(
//                   ' malumotla soni nicha akan qaniiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiii${nearestTenantState.nearestTenants.length}',
//                 );
...
//                 data: (_) {
//                   final filteredBarbers = _filterBarbers(
//                     nearestTenantState.nearestTenants,
//                   );
...
//                       final barbersToShow = filteredBarbers.isNotEmpty
...
//   // final Barber barber;
//   final NearestBarber nearestTenant;
...
//                           Expanded(
//                             child: Text(
//                               widget.nearestTenant.distanceKm
//                                   .toString(), //!= null
...
//                               Expanded(
//                                 child: Text(
//                                   widget.nearestTenant.distanceKm.toString(),
//                                   // != null
//                                   //     ? '${widget.barber.location} (${widget.barber.distance})'
//                                   //     : widget.barber.location!,
//                                   style: const TextStyle(
